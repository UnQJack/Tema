...
class VisualizationApp:
    def __init__(self, master, data):
        ...
        self.plot_first_10_button = Button(self.master,text="Primele 10 Valori",command=self.plot_first_10)
        self.plot_first_10_button.pack()

        self.plot_last_15_button = Button(self.master, text="Ultimele 15 Valori",command=self.plot_last_15)
        self.plot_last_15_button.pack()
    ...
    def plot_first_10(self):
        plt.figure(figsize=(8,6))
        plt.plot(self.data['Durata'][:10],marker='x',label='Durata')
        plt.plot(self.data['Puls'][:10],marker='x',label='Puls')
    ...
    def plot_last_15(self):
        ult = self.data[['Durata','Puls']].tail(15)
        plt.figure(figsize=(8,6))
